...
![翻转字符串](https://pic.leetcode-cn.com/Figures/151/fun2.png)
...
![字符串不可变](https://pic.leetcode-cn.com/Figures/151/reverse_whole2.png)

对于字符串可变的语言，就不需要再额外开辟空间了，直接在字符串上原地实现。在这种情况下，反转字符和去除空格可以一起完成。

![字符串可变](https://pic.leetcode-cn.com/Figures/151/mutable2.png)
...
![双端队列](https://pic.leetcode-cn.com/Figures/151/deque2.png)
